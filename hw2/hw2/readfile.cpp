                ...
                if (cmd == "light") {
                    if (numused == numLights) { // No more Lights 
                        ...
                        if (validinput && numused < 10) {
							...
							for (int k = 0; k < 4 ; k++)
							{
								lightposn[numused * 4 + k] = values[k];
								lightcolor[numused * 4 + k] = values[k + 4];
							}
							
//							cout << lightposn[numused * 4]<<" " << lightposn[numused * 4 + 1] << " " << lightposn[numused * 4 + 2] << " " << lightposn[numused * 4 + 3]  << endl;
//							cout << lightcolor[numused * 4] << " " << lightcolor[numused * 4 + 1] << " " << lightcolor[numused * 4 + 2] << " " << lightcolor[numused * 4 + 3] << endl;
                            ++numused; 
                        }
                    }
                }
...
//						printf("rotate %f %f %f %f\n", values[0], values[1], values[2], values[3]);
						...
						mat4 rotate = Transform::_rotate(values[3], axis);
                ...
                // I include the basic push/pop code for matrix stacks
					...
					cout << "push " << transfstack.size() << endl;
                    ...
                    if (transfstack.size() <= 1) {
                        ...
                        transfstack.pop(); 
						cout << "pop " << transfstack.size() << endl;
                    }
                }
